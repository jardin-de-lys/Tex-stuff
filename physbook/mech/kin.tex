...
\section{Projectile Motion}
    ...
    \begin{marginfigure}
        \hspace{-5em}
        \vspace{-3em}
        \scalebox{4}{\incfig{polar-coords}}
    ...
    \begin{example}
        ...
        $dot{\theta}$ is often refered to as the \vocab{Angular Speed}, $\omega$. We also find that
...
\section{Optimization Problems}
    ...
    \begin{example}
        ...
        \begin{soln}
            ...
            distance of $A$ and $B$ to the shore hence independent of the path taken.
