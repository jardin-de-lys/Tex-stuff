...
%for nicer question mark character
\newfontface\qmfont{Cormorant Garamond} % Define the font for the question mark

% Redefine the question mark to use Latin Modern Roman font
\newcommand{\?}{{\qmfont ?}} 