...
%fonts for chapter.
\newfontfamily\chapterfont{Jost Light}
...
%page layout
\setstocksize{260mm}{200mm}
\settrimmedsize{0.9\stockheight}{0.9\stockwidth}{*}
\setlrmarginsandblock{4.5cm}{2cm}{*}
...
\renewcommand{\chapterheadstart}{
    ...
    {\hspace*{-22mm}\color{slategreen}\rule{212mm}{25pt}} % Red box spanning the page
    \vspace{-50pt}
}
...
\renewcommand*{\printchaptertitle}[1]{%
   ...
   {\color{slategreen}\rule{170mm}{2pt}}
   \vspace{-40pt}
 }
}
...
\renewcommand*{\parttitlefont}{\chapterfont\Huge}
\renewcommand*{\partnamefont}{\normalfont\scshape\MakeLowercase}
\renewcommand*{\partnumfont}{\normalfont\scshape\MakeLowercase}

% Part number and seperator
\renewcommand*{\printpartname}{\LARGE\itshape  Part \thepart\vspace{0.2cm}}
\renewcommand*{\printpartnum}{}

\renewcommand{\midpartskip}{\vspace*{1cm}\centering
\hspace*{-1.25cm}\pgfornament[color=slategreen,width=15cm]{87}}
...
\makeevenhead{fullwidth}{{\bfseries\thepage}\;\;{\emph{\rightmark}\chapterfont}}{}{}
\makeoddhead{fullwidth}%
{}{}{%
\emph{\leftmark\chapterfont}\;\;\bfseries\thepage}
