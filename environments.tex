...
\mdfdefinestyle{mdthmbox}{%
  ...
  \declaretheoremstyle[
    headfont=\bfseries\color{coolbeige}\large,
    headformat={%
    \colorbox{slategreen}{\hspace{0mm}\textcolor{coolbeige}{\ \ \ \textsc{\NAME}\ \NUMBER}\hspace{4mm}}
    },          % Title font and color
    notefont=\normalfont,                    % Font for the optional note
    headpunct={~\\ ~\\ },                            % No punctuation after the title
    headindent=-12pt,                          % No indentation for the title
